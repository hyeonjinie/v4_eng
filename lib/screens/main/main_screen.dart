...
class _MainDashboardState extends State<MainDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        backgroundColor: Color(0xFF43A470),
        elevation: 0,
        leading: IconButton(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              InfoTextWidget(text: 'Export price per ton(dollars)'),
                              MainTopRowWidget(dataRows: [
                                {
                                  'Current(${mainData.priceInfo.currentDate})':
                                      formatCurrency(
                                          mainData.priceInfo.currentPrice)
                                },
                                {
                                  'Predicted(${mainData.priceInfo.predictedDate})':
                                      formatCurrency(
                                          mainData.priceInfo.predictedPrice)
                                },
                                {
                                  'Compared to Current':
                              ...
                              MainTableWidget(
                                dataRows: [
                                  ...
                                  ['Accuracy', '${mainData.priceInfo.accuracy}%'],
                                  [
                              ...
                              TrendChart(
                                latestPred: mainData.priceInfo.predictedPrices,
                                latestActual: mainData.priceInfo.actualPrices,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              MainTopRowWidget(dataRows: [
                                ...
                                {
                                  'Compared to Standard': formatPositiveValue(
                                      mainData.growthInfo.growthDifference)
                                },
                              ]),
                              MainTableWidget(
                                dataRows: [
                                  [
                                    'Standard Harvest',
                                    mainData.growthInfo.standardHarvestDate
                                  ],
                                  [
                                    'Standard Profit',
                                    formatCurrency(
                                        mainData.growthInfo.standardProfit)
                                  ],
                                  [
                                    'Standard Yield',
                                    formatCurrency(
                                        mainData.growthInfo.standardProduction)
                                  ],
                                  [
                                    'Forecast Harvest',
                                    mainData.growthInfo.forecastedHarvestDate
                                  ],
                                  [
                                    'Forecast Profit',
                                    formatCurrency(
                                        mainData.growthInfo.forecastedProfit)
                                  ],
                                  [
                                    'Forecast Yield',
                                    formatCurrency(mainData
                                        .growthInfo.forecastedProduction)
                                  ],
                                ],
                              ),
                              const SizedBox(
                              ...
                              ProgressBarWidget(
                                progressRate:
                                    mainData.growthInfo.currentGrowthRate / 100,
                                barColor: 'curr',
                              ),
                              const SizedBox(
                                height: 20,
                              ...
                              InfoTextWidget(text: 'Optimal Temperature for \'Growth Phase\': 25°C'),
                              MainTopRowWidget(dataRows: [
                                {
                              ...
                              TrendChart(
                                latestPred:
                                    mainData.growthInfo.predictedTemperatures,
                                latestActual:
                                    mainData.growthInfo.actualTemperatures,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              MainTableWidget(
                                dataRows: [
                                  ['Avg. Year', '${mainData.cropInfo.averageYield}'],
                                  ['Last Year', '${mainData.cropInfo.lastYearYield}'],
                                  [
                                    'Yield per 10a',
                                    '${mainData.cropInfo.productionPer10a}'
                                  ],
                                  ['Range', '${mainData.cropInfo.range}'],
                                  [
                                    'Out-of-Range Probability',
                              ...
                              TrendChart(
                                latestPred:
                                    mainData.cropInfo.predictedProductions,
                                latestActual:
